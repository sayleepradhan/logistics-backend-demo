...
Revision ID: 5156213b60cd
Revises: 
Create Date: 2026-04-09 13:08:50.149360
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('status', sa.Enum('placed', 'in_transit', 'out_for_delivery', 'delivered', name='shipmentstatus', create_type=True), nullable=False),
